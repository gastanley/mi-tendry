...
} from "./chunk-AAKARBHR.js";
import {
  ownerWindow,
  useEventCallback_default,
  useForkRef
} from "./chunk-GLDC6WY4.js";
import "./chunk-F5X6INBZ.js";
import {
  useThemeProps
} from "./chunk-NQHXMZBU.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React72 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState7 = React72.useState, useEffect20 = React72.useEffect, useLayoutEffect = React72.useLayoutEffect, useDebugValue = React72.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React72 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef15 = React72.useRef, useEffect20 = React72.useEffect, useMemo14 = React72.useMemo, useDebugValue = React72.useDebugValue;
...
var useChartDimensions = ({
  ...
  const isXInside = React3.useCallback((x2) => x2 >= drawingArea.left - 1 && x2 <= drawingArea.left + drawingArea.width, [drawingArea.left, drawingArea.width]);
  const isYInside = React3.useCallback((y2) => y2 >= drawingArea.top - 1 && y2 <= drawingArea.top + drawingArea.height, [drawingArea.height, drawingArea.top]);
  const isPointInside = React3.useCallback((x2, y2, targetElement) => {
...
var useChartInteractionListener = ({
  ...
  const gestureManagerRef = React6.useRef(null);
  React6.useEffect(() => {
  ...
  const addInteractionListener = React6.useCallback((interaction, callback, options) => {
    const svg = svgRef.current;
  ...
  const updateZoomInteractionListeners = React6.useCallback((interaction, options) => {
    const svg = svgRef.current;
    const gestureManager = gestureManagerRef.current;
...
function barPropsInterpolator(from, to) {
  const interpolateX = number_default2(from.x, to.x);
  const interpolateY = number_default2(from.y, to.y);
  const interpolateWidth = number_default2(from.width, to.width);
  const interpolateHeight = number_default2(from.height, to.height);
  return (t) => {
    return {
      x: interpolateX(t),
      y: interpolateY(t),
...
var _excluded3 = ["ownerState", "skipAnimation", "id", "dataIndex", "xOrigin", "yOrigin"];
function AnimatedBarElement(props) {
  const {
    ownerState
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded3);
  const animatedProps = useAnimateBar(props);
  return (0, import_jsx_runtime3.jsx)("rect", _extends({}, other, {
...
var _excluded4 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height"];
function BarElement(props) {
  ...
  const itemIdentifier = React23.useMemo(() => ({
    type: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]);
  ...
  const isFocused = useIsItemFocused(React23.useMemo(() => ({
    seriesType: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]));
...
function barClipPathPropsInterpolator(from, to) {
  ...
  const interpolateWidth = number_default2(from.width, to.width);
  const interpolateHeight = number_default2(from.height, to.height);
  const interpolateBorderRadius = number_default2(from.borderRadius, to.borderRadius);
  return (t) => {
    return {
      x: interpolateX(t),
      y: interpolateY(t),
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime6.jsx)(BarLabelComponent, _extends({}, otherProps, animatedProps));
}
...
var _excluded7 = ["processedSeries", "skipAnimation"];
...
function BarPlot(props) {
  ...
  const classes = useUtilityClasses3();
  return (0, import_jsx_runtime9.jsxs)(BarPlotRoot, {
    className: classes.root,
    ...
    }), completedData.map((processedSeries) => (0, import_jsx_runtime9.jsx)(BarLabelPlot, _extends({
      processedSeries,
      skipAnimation,
      barLabel
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React29.useState(typeof window !== "undefined" || false);
  React29.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function useTicks(options) {
  ...
  return React30.useMemo(() => getTicks({
    scale,
    tickNumber,
    tickPlacement,
    tickInterval,
...
function ChartsSingleXAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime11.jsx)(React33.Fragment, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React40.Fragment, {
...
var consumeThemeProps = (name, options, InComponent) => React41.forwardRef(function ConsumeThemeInternal(props, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var _excluded14 = ["type", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime21.jsx)(Root, _extends({
    ...
    children: (0, import_jsx_runtime21.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime21.jsx)(Component, {
        className: classes?.fill,
        color: color2
      }) : (0, import_jsx_runtime21.jsx)("svg", {
        viewBox: "0 0 24 24",
        preserveAspectRatio: type === "line" ? "none" : void 0,
        children: type === "circle" ? (0, import_jsx_runtime21.jsx)("circle", {
          className: classes?.fill,
          r: "12",
          cx: "12",
          cy: "12",
...
true ? ChartsLabelMark.propTypes = {
   ...
   * @default 'square'
   */
  type: import_prop_types10.default.oneOf(["circle", "line", "square"])
} : void 0;
...
var _excluded15 = ["trigger", "position", "anchor", "classes", "children"];
...
var _excluded17 = ["children", "className", "classes"];
...
var _excluded18 = ["direction", "onItemClick", "className", "classes"];
  ...
  return (0, import_jsx_runtime28.jsx)(RootElement, _extends({
    ...
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime28.jsx)("li", {
        ...
        "data-series": item.id,
        children: (0, import_jsx_runtime28.jsxs)(Element, {
          className: classes?.series,
...
var _excluded19 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var _excluded20 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  return (0, import_jsx_runtime30.jsxs)(RootElement2, _extends({
    ...
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime30.jsx)("li", {
...
var _excluded21 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded30 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend", "showToolbar", "brushConfig"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React58.useMemo(() => [{
    id: DEFAULT_X_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
  ...
  const defaultBandYAxis = React58.useMemo(() => [{
    id: DEFAULT_Y_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
      length: Math.max(...series.map((s2) => (s2.data ?? dataset ?? []).length))
  ...
  const seriesWithDefault = React58.useMemo(() => series.map((s2) => _extends({
    type: "bar"
  }, s2, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React58.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React58.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
var ChartsSlotsContext = React59.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React59.useContext(ChartsSlotsContext);
  if (context == null) {
...
var _excluded31 = ["children", "localeText", "plugins", "seriesConfig", "slots", "slotProps"];
...
true ? ChartDataProvider.propTypes = {
   ...
   */
  experimentalFeatures: import_prop_types23.default.shape({
    preferStrictDomainInLineCharts: import_prop_types23.default.bool
  }),
  /**
   ...
   */
  margin: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.shape({
   ...
   */
  series: import_prop_types23.default.arrayOf(import_prop_types23.default.object),
  /**
   * If `true`, animations are skipped.
  ...
  theme: import_prop_types23.default.oneOf(["dark", "light"]),
  /**
  ...
  return (0, import_jsx_runtime44.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime44.jsxs)(React62.Fragment, {
        children: [(0, import_jsx_runtime44.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime44.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime45.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime46.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime46.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime47.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if (colorMap?.type === "piecewise") {
        return (0, import_jsx_runtime47.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime47.jsxs)(React63.Fragment, {
          children: [(0, import_jsx_runtime47.jsx)(ChartsContinuousGradient, {
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime47.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime47.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var _excluded32 = ["children", "className", "title", "desc"];
...
var ChartsSurface = React64.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  const {
    ...
    title,
    desc
  } = themeProps, other = _objectWithoutPropertiesLoose(themeProps, _excluded32);
  const classes = useUtilityClasses15();
  const hasIntrinsicSize = svgHeight > 0 && svgWidth > 0;
  return (0, import_jsx_runtime48.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime48.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime48.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime48.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var _excluded33 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "highlightedAxis", "onHighlightedAxisChange", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText", "slots", "slotProps", "experimentalFeatures", "enableKeyboardNavigation", "brushConfig"];
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React65.cloneElement(render, props);
  }
  return React65.createElement(defaultElement, props);
}
...
var ToolbarContext = React66.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React66.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React66.useState(null);
  const focusableItemIdRef = React66.useRef(focusableItemId);
  const [items, setItems] = React66.useState([]);
  const getSortedItems = React66.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React66.useCallback((startIndex, step, wrap = true) => {
  ...
  const registerItem = React66.useCallback((id, itemRef) => {
    setItems((prevItems) => [...prevItems, {
      id,
      ref: itemRef
    }]);
  }, []);
  const unregisterItem = React66.useCallback((id) => {
    setItems((prevItems) => prevItems.filter((i) => i.id !== id));
  }, []);
  const onItemKeyDown = React66.useCallback((event) => {
    if (!focusableItemId) {
      return;
    }
    const sortedItems = getSortedItems();
  ...
  const onItemFocus = React66.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React66.useCallback((id) => {
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime49.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React67.useRef(disabled);
  React67.useEffect(() => {
  ...
  const previousAriaDisabled = React67.useRef(ariaDisabled);
  React67.useEffect(() => {
...
var _excluded34 = ["className", "render"];
...
var Toolbar = React68.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime50.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
true ? Toolbar.propTypes = {
   ...
   */
  render: import_prop_types25.default.oneOfType([import_prop_types25.default.element, import_prop_types25.default.func])
} : void 0;
...
var _excluded35 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded210 = ["tabIndex"];
var ToolbarButton = React69.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
  ...
  return (0, import_jsx_runtime51.jsx)(React69.Fragment, {
    children: element
  });
});
...
true ? ToolbarButton.propTypes = {
   ...
   */
  render: import_prop_types26.default.oneOfType([import_prop_types26.default.element, import_prop_types26.default.func]),
...
function ChartsWrapper(props) {
  ...
  const propsWidth = useSelector(store, selectorChartPropsWidth);
  const propsHeight = useSelector(store, selectorChartPropsHeight);
  return (0, import_jsx_runtime52.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types27.default.bool,
  /**
   * If `true`, the legend is not rendered.
   * @default false
   */
  hideLegend: import_prop_types27.default.bool,
  /**
   * The direction of the legend.
   * @default 'horizontal'
   */
  legendDirection: import_prop_types27.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types27.default.shape({
    horizontal: import_prop_types27.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types27.default.oneOf(["bottom", "middle", "top"])
  }),
...
var BarChart = React71.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
  ...
  return (0, import_jsx_runtime53.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime53.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime53.jsx)(Toolbar3, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime53.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime53.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime53.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime53.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime53.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime53.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime53.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime53.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime53.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime53.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? BarChart.propTypes = {
   ...
   */
  brushConfig: import_prop_types28.default.shape({
    enabled: import_prop_types28.default.bool,
    preventHighlight: import_prop_types28.default.bool,
    preventTooltip: import_prop_types28.default.bool
  }),
  ...
  enableKeyboardNavigation: import_prop_types28.default.bool,
  /**
   ...
   * If `true`, the legend is not rendered.
   */
  hideLegend: import_prop_types28.default.bool,
  /**
   * The controlled axis highlight.
   * Identified by the axis id, and data index.
   */
  highlightedAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]).isRequired,
  ...
  highlightedItem: import_prop_types28.default.shape({
    ...
    seriesId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]).isRequired
  }),
  /**
   * This prop is used to help implement the accessibility logic.
   * If you don't provide this prop. It falls back to a randomly generated id.
   ...
   * Accepts a `number` to be used on all sides or an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   */
  margin: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.shape({
   ...
   */
  onHighlightedAxisChange: import_prop_types28.default.func,
  /**
   * Callback fired when a bar item is clicked.
   * @param {React.MouseEvent<SVGElement, MouseEvent>} event The event source of the callback.
   * @param {BarItemIdentifier} barItemIdentifier The bar item identifier.
  ...
  theme: import_prop_types28.default.oneOf(["dark", "light"]),
   ...
   */
  xAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axis: import_prop_types28.default.oneOf(["x"]),
    barGapRatio: import_prop_types28.default.number,
    categoryGapRatio: import_prop_types28.default.number,
    ...
    groups: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
      getValue: import_prop_types28.default.func.isRequired,
    ...
    ignoreTooltip: import_prop_types28.default.bool,
    label: import_prop_types28.default.string,
    labelStyle: import_prop_types28.default.object,
    offset: import_prop_types28.default.number,
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["band"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    ...
    tickLabelMinGap: import_prop_types28.default.number,
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["point"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["log"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    constant: import_prop_types28.default.number,
    data: import_prop_types28.default.array,
    dataKey: import_prop_types28.default.string,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["symlog"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["pow"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["sqrt"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    label: import_prop_types28.default.string,
    labelStyle: import_prop_types28.default.object,
    max: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.shape({
      valueOf: import_prop_types28.default.func.isRequired
    })]),
    min: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.shape({
      valueOf: import_prop_types28.default.func.isRequired
    })]),
    offset: import_prop_types28.default.number,
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["time"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["utc"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    ...
    position: import_prop_types28.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["linear"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    sx: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object, import_prop_types28.default.bool])), import_prop_types28.default.func, import_prop_types28.default.object]),
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axis: import_prop_types28.default.oneOf(["y"]),
    barGapRatio: import_prop_types28.default.number,
    categoryGapRatio: import_prop_types28.default.number,
    classes: import_prop_types28.default.object,
    colorMap: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    ...
    labelStyle: import_prop_types28.default.object,
    offset: import_prop_types28.default.number,
    position: import_prop_types28.default.oneOf(["left", "none", "right"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["band"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
